...
mycursor.execute("""CREATE TABLE IF NOT EXISTS thanhvien (
                id INT(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
                HinhThe VARCHAR(1000) NOT NULL,
                HovaTen TEXT NOT NULL,
                Khoa TEXT NOT NULL,
                NamHoc TEXT NOT NULL,
                ChucVu TEXT NOT NULL,
                fanpage_id INT(255) NOT NULL)""")

# Thêm danh sách các fanpage vào bảng fanpages
fanpages = [
    ('hcmusec', 'https://www.facebook.com/hcmusec'),
    ('escussh', 'https://www.facebook.com/groups/escussh')
    
    
]
for fanpage in fanpages:
    sql = "INSERT INTO fanpages (name, url) VALUES (%s, %s)"
    val = (fanpage[0], fanpage[1])
