...
# Số ngày cần cập nhật (ví dụ: cập nhật 7 ngày trước đây)
num_days = 7

# Tính ngày bắt đầu cần cập nhật
...
for fanpage in fanpages:
    for post in get_posts(group=fanpage[1], pages=2):
        # Kiểm tra ngày tạo bài đăng
        post_date = post['time'].date()
        if post_date < target_date:
            continue  # Bỏ qua nếu bài đăng cũ hơn ngày cần cập nhật
